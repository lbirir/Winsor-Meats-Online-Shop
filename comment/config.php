...
/* ######################## DATABASE ######################## */
  ...
  // Database name
  $ACS_CONFIG["db_name"] = "winsor";
  
  // Database username
  $ACS_CONFIG["db_user"] = "root";

  // Database password
  $ACS_CONFIG["db_password"] = "";
  
  // Database table to store comments
  // (will be created automatically)
  $ACS_CONFIG["db_table"] = "comments";

/* ##################### CONFIGURATION ###################### */

  // Complete URL of the script
  // (begins with http://, ends with slash)
  $ACS_CONFIG["url"] = "http://localhost/winsor/comment/";
