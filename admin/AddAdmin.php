...
<?php
    ...
    <div class="main">
      ...
      <div class="main-content">
	   ...
	   ?>
       <h1><img src="./img/edit.gif"/>Add Admin User</h1> 
            ...
            <form method="post" action="add_admin.php">
              <fieldset><legend>&nbsp;USER DETAILS&nbsp;</legend>
                ...
                <p><label for="contact_firstname" class="left"> First Name:</label>
                   <input type="text" name="firstname" id="contact_firstname" class="field"  value="<?php echo ($_POST['firstname']); ?>" tabindex="1" /><span class="required">(*)</span></p>
                   
                   <p><label for="contact_surname" class="left"> Surname:</label>
                   <input type="text" name="surname" id="contact_surname" class="field"  value="<?php echo ($_POST['surname']); ?>" tabindex="2" /><span class="required">(*)</span></p>
                   
                   <p><label for="contact_email" class="left"> Email address:</label>
                   <input type="text" name="email" id="contact_email" class="field"  value="<?php echo ($_POST['email']); ?>" tabindex="3" /><span class="required">(*)</span></p>

                <p><label for="contact_password" class="left">Password:</label>
                   <input type="password" name="password" id="contact_password" class="field" value="<?php echo($_POST['password']); ?>" tabindex="4" /><span class="required">(*)</span></p>
